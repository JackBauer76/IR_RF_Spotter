...
void transmission()
{
  t.pulse(LED_yellow, AlarmOnTime,HIGH); // the LED_yellow is on during AlarmOnTime 
...
/* a similar code part  as Ping Out Role /Pong Back Role / change Roles
...
void motionDetector()
{
  PIRstate = !PIRstate; // when the sensor detects something 
} // the rising flank will activate an interrupt
